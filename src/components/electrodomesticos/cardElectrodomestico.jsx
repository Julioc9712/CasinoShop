...
function CardElectrodomestico({ productoElectrodomestico }) {
  ...
  return (
    <div >
      ...
      <Grid container spacing={2}>
        {productoElectrodomestico.map(product => (
          <Grid item xs={6} sm={6} md={4} lg={2.4} key={product.id}  >

            <Card sx={{ maxWidth: '300px', ml: 'auto', mr: 'auto', }}>
              <CardHeader
                action={
...
export default CardElectrodomestico